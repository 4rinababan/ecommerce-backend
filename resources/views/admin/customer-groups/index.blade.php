		...
		<div class="card card-custom gutter-b col-md-12">
			<div class="card-header flex-wrap border-0 pt-6 pb-0">
				...
				<div class="card-toolbar">
					<a href="{{route('customer-groups.create')}}" class="btn btn-primary font-weight-bolder">
					{{ Metronic::getSVG('media/svg/icons/Code/Plus.svg', 'svg-icon-md') }}New Record</a>
				</div>
			</div>
			<div class="card-body">
				<div class="mb-7">
					<div class="row align-items-center">
						<div class="col-lg-9 col-xl-8">
							<div class="row align-items-center">
								...
								{{--
								<div class="col-lg-6 col-xl-6 col-md-4 my-2 my-md-0">
									<div class="d-flex align-items-center">
										<label class="col-lg-3 col-xl-3 mr-3 mb-0 d-none d-md-block">Status :</label>
										<select class="form-control" id="group_filter_status">
				...
				<form id="form-delete" class="hidden" method="POST" action="{{ route('customer-groups.destroy', -1) }}">
					@csrf
					@method('DELETE')
				</form>
			</div>
		...
		$(document).ready(function(){
			var datatable = $('#kt_datatable').KTDatatable({
				data: {
					...
					source: {
						read: {
							url: '{{ route('adminapi.customer.list') }}',
							method: 'GET',
			...
			datatable.on('datatable-on-layout-updated', function() {
				$(".edit-btn").on('click', function(event) {
					window.location.href = "{{ url('/customer-groups') }}/"+event.currentTarget.dataset.id+"/edit";
				});
