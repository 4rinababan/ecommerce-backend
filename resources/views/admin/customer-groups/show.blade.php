		...
		<div class="card card-custom gutter-b col-md-12">
			<div class="card-header flex-wrap border-0 pt-6 pb-0">
				<div class="card-title">
					<h3 class="card-label">Brand - {$data->name}</h3>
				</div>
			</div>
			<div class="card-body">
				<div class="form-group">
					<label>Name</label>
					<input type="text" class="form-control" name="name" placeholder="Brand Name" value="{{ $data['name'] }}" autocomplete="off" readonly="readonly" />
				</div>
				<div class="form-group">
					<label>Slug</label>
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" name="website" placeholder="Brand's Website URL" value="{ $data['website'] }" autocomplete="off" readonly="readonly" />
				</div>
				--}}
				{{--
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="checkbox-inline">
						...
						<input type="checkbox" name="is_hot" {{ $data['is_hot'] == 1 ? 'checked="checked"' : '' }} />
						<span></span></label>
					</div>
				</div>
				--}}
