									...
									<div class="d-flex align-items-center mr-2">
										...
										<div class="symbol symbol-45 symbol-light-info mr-4 flex-shrink-0">
											<div class="symbol-label">
												<?php echo e(Metronic::getSVG('media/svg/icons/Shopping/Cart3.svg', 'svg-icon-lg svg-icon-info')); ?>
								...
								<div class="col">
									<div class="d-flex align-items-center mr-2">
										...
										<div class="symbol symbol-45 symbol-light-danger mr-4 flex-shrink-0">
											<div class="symbol-label">
												<?php echo e(Metronic::getSVG('media/svg/icons/Home/Library.svg', 'svg-icon-lg svg-icon-danger')); ?>
								...
								<div class="col">
									<div class="d-flex align-items-center mr-2">
										...
										<div class="symbol symbol-45 symbol-light-success mr-4 flex-shrink-0">
											<div class="symbol-label">
												<?php echo e(Metronic::getSVG('media/svg/icons/Shopping/Cart3.svg', 'svg-icon-lg svg-icon-success')); ?>
								...
								<div class="col">
									<div class="d-flex align-items-center mr-2">
										...
										<div class="symbol symbol-45 symbol-light-primary mr-4 flex-shrink-0">
											<div class="symbol-label">
												<?php echo e(Metronic::getSVG('media/svg/icons/Shopping/Barcode-read.svg', 'svg-icon-lg svg-icon-primary')); ?>
			...
			<div class="col-xl-4">
				...
				<div class="card card-custom gutter-b card-stretch bg-info">
					<div class="card-body d-flex p-0">
						<div class="flex-grow-1 bg-info p-12 pb-40 card-rounded flex-grow-1 bgi-no-repeat" style="background-position: right bottom; background-size: 55% auto; background-image: url(<?php echo e(asset('media/svg/humans/custom-6.svg)')); ?>">
					...
					<div class="card-body">
						<div class="d-flex flex-wrap align-items-center py-1">
							...
							<div class="symbol symbol-80 symbol-light-danger mr-5">
								<span class="symbol-label">
									<img src="<?php echo e(asset('media/svg/misc/008-infography.svg')); ?>" class="h-50 align-self-center" alt="" />
								</span>
							</div>
							<!--end:Pic-->
							<!--begin:Title-->
							...
							<div class="d-flex flex-column mt-10">
								...
								<div class="d-flex">
									<a href="#" class="symbol symbol-50 symbol-light-danger mr-3">
										<div class="symbol-label">
											<img src="<?php echo e(asset('media/svg/avatars/001-boy.svg')); ?>" class="h-75 align-self-end" alt="" />
										</div>
									</a>
									<a href="#" class="symbol symbol-50 symbol-light-danger mr-3">
										<div class="symbol-label">
											<img src="<?php echo e(asset('media/svg/avatars/028-girl-16.svg')); ?>" class="h-75 align-self-end" alt="" />
										</div>
									</a>
									<a href="#" class="symbol symbol-50 symbol-light-danger mr-3">
										<div class="symbol-label">
											<img src="<?php echo e(asset('media/svg/avatars/024-boy-9.svg')); ?>" class="h-75 align-self-end" alt="" />
										</div>
									</a>
									<a href="#" class="symbol symbol-50 symbol-light-danger">
										<div class="symbol-label">
											<img src="<?php echo e(asset('media/svg/avatars/005-girl-2.svg')); ?>" class="h-75 align-self-end" alt="" />
										</div>
									</a>
								</div>
							</div>
					...
					<div class="card-body">
						<div class="d-flex flex-wrap align-items-center py-1">
							...
							<div class="symbol symbol-80 symbol-light-primary mr-5">
								<span class="symbol-label">
									<img src="<?php echo e(asset('media/svg/misc/010-vimeo.svg')); ?>" class="h-50 align-self-center" alt="" />
								</span>
							</div>
							<!--end::Pic-->
							<!--begin::Title-->
									...
									<tr>
										...
										<td class="text-right pr-0">
											<a href="#" class="btn btn-icon btn-light btn-sm">
												<?php echo e(Metronic::getSVG('media/svg/icons/Navigation/Arrow-right.svg', 'svg-icon-md svg-icon-success')); ?>
...
<?php echo $__env->make('layouts.metronic', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ecommerce-backend\resources\views/layouts/partials/_old-content.blade.php ENDPATH**/ ?>