		...
		<div class="card card-custom gutter-b col-md-12">
			<div class="card-header flex-wrap border-0 pt-6 pb-0">
				<div class="card-title">
					<h3 class="card-label"><?php echo e(isset($data) ? "Update" : "Create New"); ?> Category</h3>
				</div>
			</div>
			<form method="POST" enctype="multipart/form-data" action="<?php echo e(isset($data) ? route('categories.update', $data['id']) : route('categories.store')); ?>">
				<?php echo csrf_field(); ?>
				<?php if(isset($data)): ?>
...
unset($__errorArgs, $__bag); ?>" name="name" placeholder="Category Name" value="<?php echo e(old('name') ?? (isset($data) ? $data['name'] : '')); ?>" autocomplete="off" />
...
unset($__errorArgs, $__bag); ?>">
							<div class="image-input image-input-empty" id="logo" style="background-image: url(<?php echo e(isset($data) ? Storage::url($data->logo) : asset('media/defaults/category.png')); ?>); background-size: contain; background-position: center;">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.metronic', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ecommerce-backend\resources\views/admin/categories/form.blade.php ENDPATH**/ ?>