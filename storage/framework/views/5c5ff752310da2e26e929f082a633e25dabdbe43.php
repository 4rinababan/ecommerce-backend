		...
		<div class="card card-custom gutter-b col-md-12">
			<div class="card-header flex-wrap border-0 pt-6 pb-0">
				<div class="card-title">
					<h3 class="card-label"><?php echo e(isset($data) ? "Update" : "Create New"); ?> Brand</h3>
				</div>
			</div>
			<form method="POST" enctype="multipart/form-data" action="<?php echo e(isset($data) ? route('brands.update', $data['id']) : route('brands.store')); ?>">
				<?php echo csrf_field(); ?>
				<?php if(isset($data)): ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.metronic', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ecommerce-backend\resources\views/admin/brands/form.blade.php ENDPATH**/ ?>